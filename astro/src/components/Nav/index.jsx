	...
	return (
		<nav className={Styles.nav}>
			<a className={Styles.logolink} href="/">
				<div className={Styles.monogram}>ME</div>
			</a>
			...
			<a className={Styles.social} href="https://github.com/emanum">
			...
			<a className={Styles.social} href="https://www.linkedin.com/in/manuel-eiweck/">
