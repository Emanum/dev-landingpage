...
tags:
  ...
  - virtual reality
---
import Styles from './3dmultilayer.css';


<div class="video-container">
  <iframe src="https://www.youtube.com/embed/t8p1w6cgNY8?controls=0&amp;start=6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
* [Small Dataset (774 nodes, 387 links)](https://3dmultilayer-web.emanum.dev/smallDataSet/index.html) 
* [Medium Dataset (1k nodes, 2k links)](https://3dmultilayer-web.emanum.dev/mediumDataSet/index.html)  
* [Large Dataset (1.5k nodes, 3.1k links)](https://3dmultilayer-web.emanum.dev/largeDataSet/index.html)   
* [Dataset with 6 hierarchical layers](https://3dmultilayer-web.emanum.dev/largeHierarchicalLayersDataSet/index.html) 
* [Experimental Oculus version](https://3dmultilayer-web.emanum.dev/experimentalOculus/index.html) 
